...
import dynamicsql.mapper.DepartmentMapper;
import dynamicsql.mapper.EmployeeMapperPlus;
...
public class TestPlus {
    ...
    public void testgetInfoByStep() throws Exception {
        ...
        try {
            EmployeeMapperPlus mapper = session.getMapper(EmployeeMapperPlus.class);
            Employee e = mapper.getInfoByStep(12);
    ...
    public void testGetDeptEmpsByStep() throws Exception {
        ...
        try {
            DepartmentMapper mapper = session.getMapper(DepartmentMapper.class);
            Department department = mapper.getDeptEmpsByStep(7);
